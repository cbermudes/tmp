...
export CATALINA_OPTS="-Dfile.encoding=$charset $CATALINA_OPTS"
export CATALINA_OPTS="-Dmail.mime.charset=$charset $CATALINA_OPTS"
export CATALINA_OPTS="-Duser.timezone=CET $CATALINA_OPTS"
export CATALINA_OPTS="-Duser.language=fr $CATALINA_OPTS"
export CATALINA_OPTS="-Duser.country=FR $CATALINA_OPTS"
export CATALINA_OPTS="-Xmx1024m -Xms256m -XX:MaxPermSize=512m $CATALINA_OPTS"
